...
export default function Menu(props) {
    ...
    return (
        <div>
            <div className="absolute top-10 z-20 left-1/2 p-2 transform -translate-x-1/2 w-5/6 bg-white rounded-xl">
                <embed src="/combinepdf-min.pdf" width="100%" height="800px" style={{borderRadius:"15px"}}/>
