...
export default function Menu(props) {
    ...
    return (
        <div>
            <div className="absolute top-4 z-20 left-1/2 px-2 pb-2 transform -translate-x-1/2 w-5/6 bg-white rounded-xl">
                ...
                <iframe src="/combinepdf-min.pdf" width="100%" height="600px" style={{borderRadius:"15px"}}/>
            </div>
